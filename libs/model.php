...
class Model
{
    ...
    public function uploadFile($filename, $dir, $uniqname = false)
    {
        //$dir    = "uploads/";
        $target_file = '';
    ...
    public function uploadFiles($filename, $dir, $uniqname = false)
    {
        //$dir    = "uploads/";
...
// $files = ['./first.jpg','./second.jpg','./third.jpg'];
    public function deletfiles($files = '', $directory)
    {
...
// $directory = "Articles/";
    public function alldelete($directory, $remain = '')
    {
